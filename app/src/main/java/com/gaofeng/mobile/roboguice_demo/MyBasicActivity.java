...
//@ContentView(R.layout.activity_my_basic)
public class MyBasicActivity extends Activity implements RoboContext {
    ...
    public View onCreateView(String name, Context context, AttributeSet attrs) {
        if (MyBasicActivity.shouldInjectOnCreateView(name))
            return MyBasicActivity.injectOnCreateView(name, context, attrs);
